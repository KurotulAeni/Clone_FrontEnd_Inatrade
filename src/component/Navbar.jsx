    ...
    <div className="w-full bg-primary relative z-20">
      ...
      <div className="text-white h-full  hidden text-sm py-6 px-32  lg:flex items-center gap-8 font-bold">
        ...
        <div className="dropdown dropdown-hover">
          ...
          <ul
            tabIndex={0}
            className="dropdown-content menu shadow bg-accent translate-y-6 w-52 text-xs font-normal"
          >
            ...
            <li className={perizinan ? "hover:bg-green-500" : "hidden"}>
              <a>Direktorat Ekspor-Pertanian & Kehutanan</a>
            </li>
            <li className={perizinan ? "hover:bg-green-500" : "hidden"}>
              <a>Direktorat Ekspor-Produk Industri & Pertambangan</a>
            </li>
            <li className={perizinan ? "hover:bg-green-500" : "hidden"}>
              <a>Direktorat Impor</a>
            </li>
            <li className={perizinan ? "hover:bg-green-500" : "hidden"}>
              <a>Direktorat Fasilitas Ekspor dan Impor</a>
            </li>
          </ul>
        </div>
      ...
      <div
        className={
          navResponsive
            ? "block absolute -translate-y-1 w-full z-50 lg:hidden"
            : "hidden"
        }
      >
        <Link to={"/"}>
